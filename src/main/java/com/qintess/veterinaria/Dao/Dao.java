package com.qintess.veterinaria.Dao;
...
public class Dao {
	...
	public <T> List<T> buscaTodos(Class<T> nomeClasse) {
		...
		// a nota��o "from NomeDaClasse" representa um select sem where na base de dados
		// a vari�vel nomeClasse.getName() ir� retornar o nome da entitade que queremos selecionar (ex: Compra ou Cliente)
