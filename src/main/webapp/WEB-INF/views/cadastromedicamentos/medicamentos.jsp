...
<body>
	...
	<div
		...
		<div class="w3-content">
			<h1 class="w3-center w3-jumbo" style="margin-bottom: 64px">Cadastro Medicamento</h1>
			<p>Clinica Veterinaria Arca de Noé!</p>
			<p><span class="w3-tag">ATENÇÃO</span> Cadastro de Medicamento !</p>
			<p class="w3-xxlarge"><strong>Informações do Medicamento</strong> , Preencher Formulário abaixo:
			</p><form class="container" method="post">
				<p><input class="w3-input w3-padding-16 w3-border" type="text"placeholder="Nome" required name="Nome"></p>
				<p><input class="w3-input w3-padding-16 w3-border" type="text"placeholder="Descrição" required name="descricao"></p>
