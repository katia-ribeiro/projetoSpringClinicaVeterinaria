...
<body>
	...
	<div
		...
		<div class="w3-content">
			...
			<p>
				<span class="w3-tag">ATENÇÃO</span> Cadastro de Medicamento !
			</p>
			<p class="w3-xxlarge">
				<strong>Informações do Medicamento</strong> , Preencher Formulário
				abaixo:
			</p>
			<form action="/action_page.php" target="_blank">
				...
				<p>
					<input class="w3-input w3-padding-16 w3-border" type="text"
						placeholder="Descrição" required name="Descrição">
				</p>
				<p>
					<input class="w3-input w3-padding-16 w3-border" type="text"
						placeholder="Medicamento" required name="Message">
				</p>
				<p>
