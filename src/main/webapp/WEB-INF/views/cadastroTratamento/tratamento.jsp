...
<body>
	...
	<div
		...
		<div class="w3-content">
			<h1 class="w3-center w3-jumbo" style="margin-bottom: 64px">Cadastro Tratamento</h1>
			<p>Clinica Veterinaria Arca de Noé!</p>
			<p><span class="w3-tag">ATENÇÃO</span> Cadastro de Tratamento !</p>
			<p class="w3-xxlarge"><strong>Informações do Tratamento</strong> , Preencher Formulário abaixo:</p>
			<form class="container" method="post">
				<p><input class="w3-input w3-padding-16 w3-border" type="text"placeholder="Nome do Tratamnto" required name="nomeTratamnto"></p>
				<p><input class="w3-input w3-padding-16 w3-border" type="time"placeholder=" Horário das Aplicações" required name="horaAplicacao"></p>
				<p><input class="w3-input w3-padding-16 w3-border" type="number"placeholder="Quantidade" required name="quantidade"></p>
