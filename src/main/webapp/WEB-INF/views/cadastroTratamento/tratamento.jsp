...
<body>
	...
	<div
		...
		<div class="w3-content">
			...
			<p>
				<span class="w3-tag">ATENÇÃO</span> Cadastro de Tratamento !
			</p>
			<p class="w3-xxlarge">
				<strong>Informações do Tratamento</strong> , Preencher Formulário
				abaixo:
			</p>
			<form action="/action_page.php" target="_blank">
				...
				<p>
					<input class="w3-input w3-padding-16 w3-border" type="text"
						placeholder="Consultas" required name="Consultas">
				</p>
				<p>
					<input class="w3-input w3-padding-16 w3-border" type="text"
						placeholder="Quantidade" required name="Quantidade">
				</p>
				<p>
					<input class="w3-input w3-padding-16 w3-border" type="text"
						placeholder="Medicamento" required name="Medicamento">
				</p>
				<p>
					<input class="w3-input w3-padding-16 w3-border"
						type="datetime-local" placeholder="Date and time" required
						name="date" value="2021-02-16T10:00">
				</p>
				<p>
					<input class="w3-input w3-padding-16 w3-border" type="text"
						placeholder="Tratamento" required name="Message">
				</p>
				<p>
