...
<div class="w3-container w3-padding-64 w3-blue-grey w3-grayscale-min w3-xlarge">
  <div class="w3-content">
    <h1 class="w3-center w3-jumbo" style="margin-bottom:64px">Cadastro Funcionários</h1>
    <p>Clinica Veterinaria Arca de Noé!</p>
    <p><span class="w3-tag">ATENÇÃO</span> Cadastro de Funcionários !</p>
    <p class="w3-xxlarge"><strong>Informações dos Funcionários</strong> , Preencher Formulário abaixo:</p>
    <form action="/action_page.php" target="_blank">
	  <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Nome" required name="Nome"></p>
	  <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Enderenço" required name="Endereco"></p>
	  <p><input class="w3-input w3-padding-16 w3-border" type="text" placeholder="Telefone" required name="Telefone"></p>
    </form>
  </div>
</div>
<script>
