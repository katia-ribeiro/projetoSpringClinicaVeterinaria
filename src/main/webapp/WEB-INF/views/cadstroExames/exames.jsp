...
<body>
	...
	<div
		...
		<div class="w3-content">
			<h1 class="w3-center w3-jumbo" style="margin-bottom: 64px">Cadastro Exames</h1><p>Clinica Veterinaria Arca de Noé!</p>
			<p><span class="w3-tag">ATENÇÃO</span> Cadastro de Exames !</p>
			<p class="w3-xxlarge"><strong>Informações do Exames</strong> , Preencher Formulário abaixo:</p>
